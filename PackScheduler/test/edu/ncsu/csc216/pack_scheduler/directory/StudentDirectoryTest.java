...
public class StudentDirectoryTest {
	...
	public void testGetStudentDirectory() {
		...
		sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", "pw", "pw", 15);
		sd.addStudent("Cassandra", "Schwartz", "cschwartz", "semper@imperdietornare.co.uk", "pw", "pw", 4);
        String[][] studentDirectory = sd.getStudentDirectory();
		assertEquals(2, sd.getStudentDirectory().length);
		assertEquals("Zahir", studentDirectory[0][0]);
		assertEquals("King", studentDirectory[0][1]);
		assertEquals("zking", studentDirectory[0][2]);
		assertEquals("Cassandra", studentDirectory[1][0]);
		assertEquals("Schwartz", studentDirectory[1][1]);
		assertEquals("cschwartz", studentDirectory[1][2]);
	}
	...
	public void testGetStudentById() {
	    ...
	    student = sd.getStudentById("nonexistent");
