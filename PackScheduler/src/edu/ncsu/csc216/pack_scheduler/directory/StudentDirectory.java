...
public class StudentDirectory {
	...
	/**
	 * Creates an empty student directory with an array list of Students. All students in the previous
	 * list are not listed unless saved by the user.
	 */
	 ...
	 * @throws IllegalArgumentException if the password is invalid or if the passwords don't match
	 */
