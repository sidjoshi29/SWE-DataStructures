...
public class SkipListMapTest {
    ...
    public void testStudentMap() {
        ...
        assertEquals("SkipListMap[Student [first=J, last=K, id=1, creditHours=0, gpa=0.0, unityID=jk]]", studentMap.toString());
        assertEquals(1, studentMap.size());
        assertEquals(Integer.valueOf(2), studentMap.get(s1));
        assertNull(studentMap.put(s2, 1));
        assertNull(studentMap.put(s3, 3));
        assertNull(studentMap.put(s4, 2));
        assertNull(studentMap.put(s5, 1));
        assertEquals(Integer.valueOf(1), studentMap.put(s5, 5));
    }
