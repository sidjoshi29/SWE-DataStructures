...
public class BinarySearchTreeMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
    ...
    protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
         ...
         * 
         * The code for this method is based on the BalanceableBinaryTree algorithm in the course textbook
        ...
        public void rotate(Position<Entry<K, V>> p) {
            ...
            if(grandParent == null) {
            	...
            	//parent.equals(left(grandParent))
            ...
            if(node.equals(parent.getLeft())) {
            	relink(parent, validate(node.getRight()), true);
            	relink(node, parent, false);
            } else {
            	relink(parent, validate(node.getLeft()), false);
